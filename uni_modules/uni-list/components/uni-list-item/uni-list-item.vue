	...
	<cell :keep-scroll-position="keepScrollPosition">
		...
		<view :class="{ 'uni-list-item--disabled': disabled }"
			...
			<view v-if="!isFirstChild"
				class="border--left"
				:class="{ 'uni-list--border': border }"></view>
			<view class="uni-list-item__container"
				...
				<slot name="header">
					<view class="uni-list-item__header">
						...
						<view v-else-if="showExtraIcon"
							class="uni-list-item__icon">
							<uni-icons :customPrefix="extraIcon.customPrefix"
				...
				<slot name="body">
					<view class="uni-list-item__content"
						...
						<text v-if="note"
							class="uni-list-item__content-note">{{ note }}</text>
					</view>
				</slot>
				<slot name="footer">
					<view v-if="rightText || showBadge || showSwitch"
						class="uni-list-item__extra"
						:class="{ 'flex--justify': direction === 'column' }">
						<text v-if="rightText"
							class="uni-list-item__extra-text">{{ rightText }}</text>
