  ...
  const _sfc_main$j = {
    ...
    props: {
      ...
      handleClick: {
        type: Function,
        default: () => {
          formatAppLog("log", "at components/Swiper2.vue:108", "点击了");
        }
      }
    },
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("swiper", {
          ...
          vue.createCommentVNode(" 是否需要显示标题 "),
...
This will fail in production if not fixed.`);
  ...
  const usePlayerStore = defineStore("player", {
    ...
    actions: {
      ...
      //单曲循环
      playLoop() {
        formatAppLog("log", "at stores/player.js:121", "重播");
        audio.currentTime = 0;
        this.playing = false;
        this.play();
      },
      ...
      playInOrder() {
        ...
        if (this.index == this.nowPlayList.length) {
          audio = null;
          return formatAppLog("log", "at stores/player.js:135", "播放结束");
        }
        this.getAudio();
        ...
        return vue.openBlock(), vue.createElementBlock(
          ...
          [
            vue.createElementVNode("div", { class: "content" }, [
              ...
              vue.createElementVNode("text", { class: "title" }, "歌单推荐"),
              vue.createVNode(Swiper2, {
              ...
              vue.createElementVNode("text", { class: "title" }, "精选歌曲"),
              vue.createVNode(Swiper2, {
              ...
              vue.createElementVNode("text", { class: "title" }, "雷达歌单"),
              vue.createVNode(Swiper2, {
              ...
              vue.createElementVNode("text", { class: "title" }, "新歌速递"),
              vue.createVNode(Swiper2, {
              ...
              vue.createElementVNode("text", { class: "title" }, "新专速递"),
              vue.createVNode(Swiper2, {
              ...
              vue.createElementVNode("text", { class: "title" }, "最新数字专辑"),
              vue.createVNode(Swiper2, {
        ...
        return vue.openBlock(), vue.createElementBlock(
          ...
          [
            vue.createElementVNode("view", { class: "search" }, [
              ...
              vue.createCommentVNode(" 搜索建议弹出层 "),
          ...
          [
            ...
            vue.unref(playerStore).name ? (vue.openBlock(), vue.createElementBlock("view", {
              ...
              vue.createElementVNode("view", { class: "operation" }, [
                vue.createCommentVNode(" 播放模式 "),
                vue.createVNode(PlayMode),
                vue.createCommentVNode(" 加入我的喜欢 "),
                vue.createCommentVNode(" 播放暂停 "),
                vue.createVNode(Play)
              ])
            ])) : vue.createCommentVNode("v-if", true),
            vue.createCommentVNode(" 播放组件的弹窗详情 "),
            vue.createVNode(
              _component_uni_popup,
              {
